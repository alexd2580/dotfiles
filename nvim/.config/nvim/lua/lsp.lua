...
load_lsp_client("ltex",
  { filetypes = { "bib", "org", "plaintex", "rst", "rnoweb", "tex", "pandoc", "quarto", "rmd", "context", "mail" } })
load_lsp_client "bashls" -- Install shellcheck and shfmt. See BLS docs for info.
load_lsp_client "clangd"
load_lsp_client "cmake"
load_lsp_client "vimls"
load_lsp_client "marksman" -- Install marksman package.
...
load_lsp_client "terraformls"

local pythonRootMarkers = {
  ".isort.cfg",
  "pyproject.toml",
  "setup.cfg",
  "setup.py",
